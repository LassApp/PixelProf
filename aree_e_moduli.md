// qui dentro ci sono tutte le aree e i moduli a loro assegnati
...
- **Computer Essentials**
  - Chiave: `computer-essentials`
  - Stato: `attivo`

- **Online Essentials**
  - Chiave: `online-essentials`
  - Stato: `attivo`
...
> I tre moduli ECDL sono gli unici moduli attualmente presenti nel progetto.
...
**Stato:** attiva
**Nota:** contenuti presenti, JSON realizzare e da caricare.
