...
- **Fondamenti della sicurezza**
  ...
  - File: `lo_sapevi_fondamenti-della-sicurezza.json` *(creato — 55 schede)*

- **Il malware**
  - Chiave: `il-malware`
  - Stato: `attivo`
  - Path base: `data/Didattica/Lo_Sapevi/ECDL/IT_Security/Modulo2/`
  - File: `lo_sapevi_il-malware.json` *(creato — 56 schede)*

- **Reti e accessi**
  - Chiave: `reti-e-accessi`
  - Stato: `attivo`
  - Path base: `data/Didattica/Lo_Sapevi/ECDL/IT_Security/Modulo3/`
  - File: `lo_sapevi_reti-e-accessi.json` *(creato — 53 schede)*
...
- **Navigazione e comunicazione sicura**
  ...
  - File: `lo_sapevi_navigazione-e-comunicazione-sicura.json` *(creato — 52 schede)*
...
- **Protezione e conservazione dei dati**
  ...
  - File: `lo_sapevi_protezione-e-conservazione-dei-dati.json` *(creato — 50 schede)*
